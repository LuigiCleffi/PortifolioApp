...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ? false ? invariant(false, "Could not find a matching route for the current errors: " + errors) : invariant(false) : void 0;
...
function useSubmitImpl(fetcherKey, routeId) {
  ...
  return React2.useCallback(function(target, options) {
    ...
    if (fetcherKey) {
      !(routeId != null) ? false ? invariant(false, "No routeId available for useFetcher()") : invariant(false) : void 0;
