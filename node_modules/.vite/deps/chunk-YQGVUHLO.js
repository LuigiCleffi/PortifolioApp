...
function useMounted() {
  var mounted = (0, import_react10.useRef)(true);
  var isMounted = (0, import_react10.useRef)(function() {
...
var PageItem = React4.forwardRef(({
  active,
  disabled,
  className,
  style,
  ...
  return (0, import_jsx_runtime4.jsx)("li", {
    ...
    children: (0, import_jsx_runtime5.jsxs)(Component, {
      className: "page-link",
      disabled,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime4.jsx)("span", {
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React4.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime5.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React5.forwardRef(({
  bsPrefix,
  className,
  size,
  ...props
  ...
  return (0, import_jsx_runtime6.jsx)("ul", {
    ref,
    ...props,
...
*/
//# sourceMappingURL=chunk-YQGVUHLO.js.map
