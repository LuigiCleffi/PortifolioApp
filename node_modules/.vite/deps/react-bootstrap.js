...
var AbstractModalHeader = React77.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
...
var ModalHeader = React78.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
var Modal2 = React79.forwardRef(({
  ...
  const renderBackdrop = (0, import_react62.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
...
var OffcanvasToggling = React85.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime81.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React85.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React86.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
var Offcanvas = React87.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react68.useCallback)((backdropProps) => (0, import_jsx_runtime83.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React90.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react75.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
